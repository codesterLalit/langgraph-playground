...
def authenticate(email: str, password: str, runtime: ToolRuntime) -> Command:
    ...
    authenticated = (
        email == runtime.context.email_address and password == runtime.context.password
    )
    message = "Successfully authenticated" if authenticated else "Authentication failed"
    return Command(
        update={
